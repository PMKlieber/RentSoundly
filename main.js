...
var vectorSource=new VectorSource({
    url: geoserverAddr+'/geoserver/rentsoundly/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=rentsoundly%3Arentplotagg&maxFeatures=50&outputFormat=application%2Fjson&viewparams=n:0',
    format: new GeoJSON(),
  });
...
const hostname="http://172.232.173.160:3000"
...
{
  vectorSource.setUrl(geoserverAddr+'/geoserver/rentsoundly/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=rentsoundly%3Arentplotagg&maxFeatures=5000&outputFormat=application%2Fjson&viewparams=n:' + landlordid)
...
async function findRelatedProp(landlordid)
{
  ...
  Object.entries(rjson).forEach(([key, value]) => {
	...
	relPropEvents.set(value['id'],  function() {
